...
export default class TrainsBetween extends Component {
  ...
  description = (param, journey) => {
    ...
    return `${number} trains for ${codeName} - ${fullName}. Best Train ${bestTrain.train.all_data[0]} - ${bestTrain.train.all_data[1]}, takes ${bestTrain.duration}. Get train timings, running status.`;
  };
